...
> "Now the candidate joins one voice interview — the same fair conversation every applicant gets."
*(Let the AI ask a question; candidate answers; orb reacts.)*
> "It's not reading a script — it follows up on what they actually say."
*(Show an adaptive follow-up: "You said you stayed on the line — what was going through your mind?")*
> "And here's what nobody else does — the candidate can ask it anything, even —"
*(Candidate:)* "How am I being judged here?"
*(Agent answers honestly from the rubric.)*
> "It tells them. Transparent to both sides, in real time."

## 1:50 – 2:35 · Moment 3 — The glass-box verdict (the differentiator)
...
### Production notes
- Pre-seed Customer Support + a candidate so every click is instant.
- If live generation is risky, pre-run it once and screen-record the good take.
- Keep the orb moment longest — it's the ElevenLabs bonus money shot.
- Subtitles on (judges may watch muted).
- Total hard cap 3:00 — cut the hook before you cut the interview.
