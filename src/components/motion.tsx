...
export function PrimaryButton({
  ...
  return (
    <MotionLink
      ...
      className={`group relative inline-flex h-12 items-center justify-center gap-2 overflow-hidden rounded-full bg-accent px-7 font-medium text-white shadow-[var(--shadow-button-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${className}`}
    >
      <Shimmer />
      {children}
    </MotionLink>
